...
export class PostFactory {
  ...
  static createWithTranslations(overrides: Partial<Post> = {}): Post & { translations: PostTranslation[] } {
...
export class PostTranslationFactory {
  ...
  static createMany(count: number, overrides: Partial<PostTranslation> = {}): PostTranslation[] {
