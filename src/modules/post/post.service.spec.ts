...
import { CreatePostDtoFactory, PostFactory, UpdatePostDtoFactory } from '../../../test/factories';
import { mockDrizzleService } from '../../../test/mocks/drizzle.mock';
import { mockCommandBus } from '../../../test/mocks/services.mock';
...
describe('PostService', () => {
  ...
  describe('createPost', () => {
    it('should create a post using command bus', async () => {
      ...
      // Act
      const result = await service.createPost(userId as Uuid, createPostDto);

      // Assert
      expect(result).toEqual(expectedPost);
      expect(mockCommandBus.execute).toHaveBeenCalledWith(expect.any(CreatePostCommand));
    });
  });
  ...
  describe('getSinglePost', () => {
    it('should return a post when found', async () => {
      ...
      // Act
      const result = await service.getSinglePost(postId as Uuid);
    ...
    it('should throw PostNotFoundException when post not found', async () => {
      ...
      // Act & Assert
      await expect(service.getSinglePost(postId as Uuid)).rejects.toThrow(PostNotFoundException);
    });
  });
  ...
  describe('updatePost', () => {
    it('should update a post successfully', async () => {
      ...
      // Act
      const result = await service.updatePost(postId as Uuid, updatePostDto);
  ...
  describe('deletePost', () => {
    it('should delete a post successfully', async () => {
      ...
      // Act
      await service.deletePost(postId as Uuid);
    ...
    it('should throw PostNotFoundException when post to delete not found', async () => {
      ...
      // Act & Assert
      await expect(service.deletePost(postId as Uuid)).rejects.toThrow(PostNotFoundException);
      expect(mockDrizzleService.database.select).toHaveBeenCalled();
    });
  });
});
