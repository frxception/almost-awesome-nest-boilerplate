...
import { mockUserService, mockJwtService, mockConfigService } from '../../../test/mocks/services.mock.ts';
import { UserFactory, UserLoginDtoFactory } from '../../../test/factories/index.ts';
...
describe('AuthService', () => {
  ...
  describe('validateUser', () => {
    it('should return user when credentials are valid', async () => {
      ...
      expect(mockUserService.findOne).toHaveBeenCalledWith({ email: userLoginDto.email });
