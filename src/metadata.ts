  ...
  return {
    '@nestjs/swagger/plugin': {
      models: [
        ...
        [
          import('./common/dto/abstract.dto'),
          {
            AbstractDto: {
              ...
              translations: {
                required: false,
                type: () => [t['./common/dto/abstract.dto'].AbstractTranslationDto],
              },
            },
        ...
        [import('./modules/user/dtos/users-page-options.dto'), { UsersPageOptionsDto: {} }],
        [
        ...
        [
          import('./modules/post/dtos/create-post.dto'),
          {
            CreatePostDto: {
              title: {
                required: true,
                type: () => [t['./common/dto/create-translation.dto'].CreateTranslationDto],
              },
              description: {
                required: true,
                type: () => [t['./common/dto/create-translation.dto'].CreateTranslationDto],
        ...
        [
          import('./modules/post/dtos/post.dto'),
          {
            PostDto: {
              ...
              translations: {
                required: false,
                type: () => [t['./modules/post/dtos/post-translation.dto'].PostTranslationDto],
              },
            },
          },
        ],
        [import('./modules/post/dtos/post-page-options.dto'), { PostPageOptionsDto: {} }],
